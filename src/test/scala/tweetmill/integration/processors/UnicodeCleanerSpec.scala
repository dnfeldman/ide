...
class UnicodeCleanerSpec extends FunSpec with HelperMethods{
  ...
  describe("HashtagGraphAnalyzer") {
    ...
    val tweet5 = makeTweet(text = "   bunch of \t and \t\t and \n and \n\n\n")

    val tweetStream = List(tweet0, tweet1, tweet2, tweet3, tweet4, tweet5)
    val unicodeCleaner = makeUnicodeCleaner

    it("removes unicode, replaces escape characters, and keeps track of tweets with unicode"){
      ...
      val correctOutputEntries = List(
        ...
        "no unicode (timestamp: Fri Jun 05 20:00:00 +0000 2015)",
        " bunch of and and and  (timestamp: Fri Jun 05 20:00:00 +0000 2015)"
      )
